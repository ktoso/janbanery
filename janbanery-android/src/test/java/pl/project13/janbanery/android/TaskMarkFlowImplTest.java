 ...
 */
@Ignore("It's not runnable when Log.i is uncommented (for now)")
public class TaskMarkFlowImplTest {
  ...
  public void setUp() throws Exception {
    ...
    janbanery = new JanbaneryFactory(new AndroidCompatibleRestClient()).connectUsing(conf).toWorkspace(EXISTING_WORKSPACE);
  }
